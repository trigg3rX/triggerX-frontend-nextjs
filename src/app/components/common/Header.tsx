...
const Header: React.FC = () => {
    ...
    const handleMouseEnter = (event: React.MouseEvent<HTMLAnchorElement>) => {
        ...
        setHighlightStyle({
            ...
            transition: prevRect ? "all 0.3s ease" : "opacity 0.1s linear, transform 0.3s ease, width 0.3s ease", // Smoother initial transition
        });
        setPrevRect(rect);
    };

    const handleMouseLeaveNav = () => { // Renamed to avoid conflict if NavLink had its own
    ...
    return (
        <header className="fixed top-0 left-0 right-0 w-full headerbg bg-[#0a0a0a]/80 backdrop-blur-md z-50">
            ...
            <div className="md:w-[90%] mx-auto my-6 md:my-8 header hidden lg:flex items-center justify-between">
                <div>
                    <a href="https://www.triggerx.network/" target="_blank" rel="noopener noreferrer">
                        <Image src={logo} alt="TriggerX Logo" width={180} height={40} priority className="xl:w-[200px]" />
                    </a>
                </div>

                <div className="relative flex flex-col items-center">
                    <div // Using div for positioning, Image for actual image
            ...
            <div className="w-[90%] mx-auto flex justify-between items-center my-6 header lg:hidden">
                ...
                >
                    <Image src={landingImg} alt="Mobile Navigation Background" width={256} height={100} className="w-64 h-auto" />
                </div>

                <div className="flex-shrink-0 relative z-10">
                    <a href="https://www.triggerx.network/" target="_blank" rel="noopener noreferrer">
                        <Image src={logo} alt="TriggerX Logo" width={130} height={30} className="w-[140px] md:w-[170px] h-auto" />
                    </a>
                </div>
