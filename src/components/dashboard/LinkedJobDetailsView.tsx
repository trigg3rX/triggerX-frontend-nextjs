...
interface LinkedJobDetailsViewProps {
  job: JobType;
  onBack: () => void;
  onJobDeleted?: () => void;
  onViewMainJob?: () => void; // Add this prop for navigating to main job
}
...
const LinkedJobDetailsView: React.FC<LinkedJobDetailsViewProps> = ({
  job,
  onBack,
  onJobDeleted,
  onViewMainJob, // Add this prop
}) => {
  ...
  const tabs = [
    {
      ...
      label: "Linked Job Details",
      icon: Settings,
      count: null,
    },
    {
      id: "logs" as TabType,
      label: "Linked Job Logs",
      icon: FileText,
    ...
    <div className="space-y-6 my-10">
      ...
      <div className="flex flex-col sm:flex-row gap-4 justify-between items-start">
        ...
        <div className="flex items-center gap-2 self-end sm:self-auto">
          ...
          {onViewMainJob && (
            <Button
              onClick={onViewMainJob}
              aria-label="View Main Job"
              color="white"
            >
              View Main Job
            </Button>
            ...
            {job.type === "Time-based" && (
              <div className="border-t border-[#2A2A2A] pt-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="flex items-center justify-between p-3 rounded-lg bg-[#2A2A2A]/50 transition-colors duration-200">
                    <Typography variant="body" color="primary">
                      Time Interval:
                    </Typography>
                    <Typography
